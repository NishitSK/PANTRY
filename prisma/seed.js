...
async function main() {
  ...
  const products = [
    ...
    { name: 'Butter', category: 'Dairy', base: 30, room: 7, fridge: 90, freezer: 365, storage: 'fridge', notes: 'Can freeze. Room temp: 7-10 days.' },
    ...
    { name: 'Ketchup', category: 'Condiments & Sauces', base: 365, room: 30, fridge: 730, freezer: 0, storage: 'fridge', notes: 'Refrigerate after opening. Quality drops at room temp after 30 days.' },
    { name: 'Mustard', category: 'Condiments & Sauces', base: 365, room: 30, fridge: 730, freezer: 0, storage: 'fridge', notes: 'Long lasting. Quality drops at room temp after 30 days.' },
    ...
    // Eggs & Tofu (6 items)
    { name: 'Eggs', category: 'Eggs & Tofu', base: 28, room: 7, fridge: 35, freezer: 365, storage: 'fridge', notes: 'Keep in carton. Room temp: 7-10 days.' },
