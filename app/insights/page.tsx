        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 border-4 border-black bg-white p-4 sm:p-6 shadow-[8px_8px_0_#000]">
            <div className="space-y-4">
                ...
                <p className="text-black/80 font-manrope text-base sm:text-lg max-w-xl leading-relaxed">
                    Deciphering the patterns of your preservation habits. Your kitchen is currently performing at high efficiency with minimal waste.
                </p>
            </div>
            <div className="block">
            ...
            <div className="bg-white p-8 border-4 border-black shadow-[6px_6px_0_#000] transition-all group overflow-hidden relative">
                ...
                <div className="relative space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-black/70 uppercase tracking-widest mt-1">Purity Level</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-8">
            ...
            <div className="col-span-12 lg:col-span-4 space-y-6">
                <div className="bg-black text-white p-6 sm:p-8 md:p-10 relative overflow-hidden border-4 border-black shadow-[8px_8px_0_#93E1A8]">
                    ...
                    <h3 className="text-2xl font-noto-serif mb-4">The Preservation Quotient</h3>
                    <p className="text-stone-400 font-manrope text-sm leading-relaxed mb-8">
                        Your pantry is currently at 85% freshness capacity. By matching your recipes to your stock, you have reduced waste by 12% this month.
                    </p>
                    <div className="space-y-4">
                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1">
                            <span>Efficiency</span>
                            <span className="text-[#93E1A8]">High</span>
                        </div>
                        <div className="h-2 w-full bg-white/10 border border-white overflow-hidden">
                            <div className="h-full w-[85%] bg-[#93E1A8]" />
                        </div>
                    </div>
                </div>

                <div className="bg-white p-5 sm:p-8 border-4 border-black shadow-[8px_8px_0_#000] flex items-center gap-4 sm:gap-6">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#FFE66D] border-2 border-black flex items-center justify-center text-2xl sm:text-3xl font-noto-serif font-bold text-black">
                        12
                    </div>
                    <div>
                        <p className="font-black text-black uppercase tracking-[0.1em]">Items Rescued</p>
                        <p className="text-xs text-black/70">Successfully integrated into meals before expiration.</p>
                    </div>
                </div>
            </div>
        </div>
